(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["recommend-recommendation-result-recommendation-result-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppRecommendRecommendationResultRecommendationResultPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppRecommendRecommendationResultRecommendationResultRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecommendationResultPageRoutingModule", function () {
        return RecommendationResultPageRoutingModule;
      });
      /* harmony import */
      ...
      var _recommendation_result_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var routes = [Object.assign({
        path: '',
        component: _recommendation_result_page__WEBPACK_IMPORTED_MODULE_4__["RecommendationResultPage"]
      }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_2__["canActivate"])(redirectUnauthorizedToLogin))];

      var RecommendationResultPageRoutingModule = function RecommendationResultPageRoutingModule() {
        _classCallCheck(this, RecommendationResultPageRoutingModule);
      };

      RecommendationResultPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppRecommendRecommendationResultRecommendationResultModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecommendationResultPageModule", function () {
        return RecommendationResultPageModule;
      });
      /* harmony import */
      ...
      var _recommendation_result_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./recommendation-result-routing.module */
      "./src/app/recommend/recommendation-result/recommendation-result-routing.module.ts");
      /* harmony import */


      var _recommendation_result_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./recommendation-result.page */
      "./src/app/recommend/recommendation-result/recommendation-result.page.ts");

      var RecommendationResultPageModule = function RecommendationResultPageModule() {
        _classCallCheck(this, RecommendationResultPageModule);
      };

      RecommendationResultPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _recommendation_result_routing_module__WEBPACK_IMPORTED_MODULE_5__["RecommendationResultPageRoutingModule"]],
    ...
    /***/
    function srcAppRecommendRecommendationResultRecommendationResultPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppRecommendRecommendationResultRecommendationResultPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecommendationResultPage", function () {
      ...
      var src_app_service_wisata_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/service/wisata.service */
      ...
      var RecommendationResultPage = /*#__PURE__*/function () {
        function RecommendationResultPage(router, storage, toastController, wisataService, fireStorage) {
          _classCallCheck(this, RecommendationResultPage);
        ...
        _createClass(RecommendationResultPage, [{
          key: "ngOnInit",
          ...
          value: function ionViewWillEnter() {
            ...
            this.array = Promise.all([this.p1, this.p2, this.p3, this.p4]).then(function (arr) {
              // checking 
              if (arr[0] == null) {
                _this.presentToast();
                ...
                _this.router.navigate(['/recommendation3']);
              } else if (!arr[3]) {
                _this.presentToast();

                _this.router.navigate(['/recommendation4']);
              }

              _this.wisataService.getWisata().subscribe(function (res) {
                return res.map(function (m) {
                  _this.waktu = m.jam.split("-");

                  if (m.kategori == arr[2] && m.daerah == arr[3].toLowerCase() && arr[1] == 'pagi' && arr[0] == 'less') {
                    if (m.harga <= 100000 && _this.waktu[0] >= '05:00' && _this.waktu[0] < '10:00' || _this.waktu[1] >= '05:00' && _this.waktu[1] < '10:00') {
                      console.log('pagi');
                      m.gambarUrl = _this.getImageUrl(m.gambar[0]);

                      _this.recommendResult.push(m);
                    }
                  } else if (m.kategori == arr[2] && m.daerah == arr[3].toLowerCase() && arr[1] == 'siang' && arr[0] == 'less') {
                    if (m.harga <= 100000 && _this.waktu[0] >= '10:00' && _this.waktu[0] < '16:00' || _this.waktu[1] >= '10:00' && _this.waktu[1] < '16:00') {
                      console.log('siang');
                      m.gambarUrl = _this.getImageUrl(m.gambar[0]);
                    ...
                    if (m.harga <= 100000 && _this.waktu[0] >= '16:00' && _this.waktu[0] < '20:00' || _this.waktu[1] >= '16:00' && _this.waktu[1] < '20:00') {
                      console.log('sore');
                      m.gambarUrl = _this.getImageUrl(m.gambar[0]);
                    ...
                    if (m.harga <= 100000 && _this.waktu[0] >= '20:00' && _this.waktu[0] <= '24:00' && _this.waktu[0] >= '00:00' && _this.waktu[0] > '05:00' || _this.waktu[1] >= '20:00' && _this.waktu[1] <= '24:00' && _this.waktu[1] >= '00:00' && _this.waktu[1] > '05:00') {
                      m.gambarUrl = _this.getImageUrl(m.gambar[0]);
          ...
          value: function getImageUrl(imageName) {
            return this.fireStorage.ref("wisata/".concat(imageName)).getDownloadURL();
          }
        }, {
          key: "tryAgain",
      ...
      RecommendationResultPage.ctorParameters = function () {
        return [{
      ...
      RecommendationResultPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-recommendation-result',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./recommendation-result.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/recommend/recommendation-result/recommendation-result.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./recommendation-result.page.scss */
        "./src/app/recommend/recommendation-result/recommendation-result.page.scss"))["default"]]
      })], RecommendationResultPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=recommend-recommendation-result-recommendation-result-module-es5.js.map
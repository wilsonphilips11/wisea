...
/* harmony import */ var _explore_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./explore.page */ "./src/app/menu/explore/explore.page.ts");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | explore-detail-map-location-map-location-module */ "map-location-map-location-module").then(__webpack_require__.bind(null, /*! ./explore-detail/map-location/map-location.module */ "./src/app/menu/explore/explore-detail/map-location/map-location.module.ts")).then(m => m.MapLocationPageModule)
    },
    {
        path: 'explore-detail/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | explore-detail-explore-detail-module */ "explore-detail-explore-detail-module").then(__webpack_require__.bind(null, /*! ./explore-detail/explore-detail.module */ "./src/app/menu/explore/explore-detail/explore-detail.module.ts")).then(m => m.ExploreDetailPageModule)
    },
    {
        path: 'list-item/:order',
        loadChildren: () => Promise.all(/*! import() | list-item-list-item-module */[__webpack_require__.e("default~edit-profile-edit-profile-module~list-item-list-item-module"), __webpack_require__.e("list-item-list-item-module")]).then(__webpack_require__.bind(null, /*! ./list-item/list-item.module */ "./src/app/menu/explore/list-item/list-item.module.ts")).then(m => m.ListItemPageModule)
    },
    {
        path: 'shopping-cart/:id',
        loadChildren: () => Promise.all(/*! import() | shopping-cart-shopping-cart-module */[__webpack_require__.e("common"), __webpack_require__.e("shopping-cart-shopping-cart-module")]).then(__webpack_require__.bind(null, /*! ./shopping-cart/shopping-cart.module */ "./src/app/menu/explore/shopping-cart/shopping-cart.module.ts")).then(m => m.ShoppingCartPageModule)
    }
];
...
/* harmony import */ var _explore_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./explore-routing.module */ "./src/app/menu/explore/explore-routing.module.ts");
/* harmony import */ var _explore_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./explore.page */ "./src/app/menu/explore/explore.page.ts");
...
/* harmony import */ var _service_database_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../service/database.service */ "./src/app/service/database.service.ts");
...
let ExplorePage = class ExplorePage {
    constructor(authService, wisataService, storage, navCtrl, loadingController, databaseService, firestore) {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.pertunjukanList = this.wisataService.getWisata('pertunjukan').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(wisataList => wisataList.map(wisata => {
                wisata.gambarUrl = this.getImageUrl(wisata.gambar[0]);
                return wisata;
            })));
            this.museumList = this.wisataService.getWisata('museum').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(wisataList => wisataList.map(wisata => {
                wisata.gambarUrl = this.getImageUrl(wisata.gambar[0]);
                return wisata;
            })));
            this.workshopList = this.wisataService.getWisata('workshop').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(wisataList => wisataList.map(wisata => {
                wisata.gambarUrl = this.getImageUrl(wisata.gambar[0]);
                return wisata;
            })));
            yield this.authService.getPromiseUserData().then((user) => {
...
ExplorePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./explore.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/menu/explore/explore.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./explore.page.scss */ "./src/app/menu/explore/explore.page.scss")).default]
    })
], ExplorePage);

...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | history-detail-history-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("history-detail-history-detail-module")]).then(__webpack_require__.bind(null, /*! ./history-detail/history-detail.module */ "./src/app/history/history-detail/history-detail.module.ts")).then(m => m.HistoryDetailPageModule)
    }
];
...
let HistoryPage = class HistoryPage {
    constructor(authService, firestore, router, navCtrl) {
    ...
    getHistory() {
        this.authService.getUserData().subscribe(res => {
            ...
            this.firestore.collection('history').ref.where('email', '==', this.userProfile.email).orderBy('tanggal', 'desc').get().then((ref) => {

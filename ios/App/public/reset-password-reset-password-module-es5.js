  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reset-password-reset-password-module"], {
    ...
    function srcAppResetPasswordResetPasswordRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | email-confirmation-email-confirmation-module */
          [__webpack_require__.e("default~edit-profile-edit-profile-module~email-confirmation-email-confirmation-module~login-login-mo~30f52c33"), __webpack_require__.e("common"), __webpack_require__.e("email-confirmation-email-confirmation-module")]).then(__webpack_require__.bind(null,
          /*! ./email-confirmation/email-confirmation.module */
          "./src/app/reset-password/email-confirmation/email-confirmation.module.ts")).then(function (m) {
            return m.EmailConfirmationPageModule;
          });
        }
      }];
    ...
    function srcAppResetPasswordResetPasswordPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ResetPasswordPage = /*#__PURE__*/function () {
        function ResetPasswordPage(formBuilder, router, authService, loadingController, alertController) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 5:
                      ...
                      this.authService.checkAvailablePhone(phone).subscribe(function (res) {
                        console.log('Inputted phone number\'s data: ', res[0]);
                        var userPhone = res[0].phone;
                        var userEmail = res[0].email;

                        if (userPhone === phone) {
                          _this.authService.resetPassword(userEmail).then(function () {
                            loading.dismiss();

                            _this.presentAlert('Reset password sukses!', 'Silahkan mengkonfirmasi pesan yang telah dikirimkan melalui email anda');
                          ...
                          _this.presentAlert('Reset password gagal', 'Nomor yang dimasukkan tidak terdaftar');
                        }
                      });
